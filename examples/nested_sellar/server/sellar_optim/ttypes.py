...
class SellarDisc1Input(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('SellarDisc1Input')
        if self.x is not None:
            oprot.writeFieldBegin('x', TType.DOUBLE, 1)
            oprot.writeDouble(self.x)
            oprot.writeFieldEnd()
...
class SellarDisc1Output(object):
    """
    Attributes:
     - y1
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('SellarDisc1Output')
        if self.y1 is not None:
...
class SellarDisc2Input(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('SellarDisc2Input')
        if self.y1 is not None:
            oprot.writeFieldBegin('y1', TType.DOUBLE, 1)
            oprot.writeDouble(self.y1)
            oprot.writeFieldEnd()
...
class SellarDisc2Output(object):
    """
    Attributes:
     - y2
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('SellarDisc2Output')
        if self.y2 is not None:
...
all_structs.append(SellarDisc1Input)
SellarDisc1Input.thrift_spec = (
    None,  # 0
    (1, TType.DOUBLE, 'x', None, None, ),  # 1
    (2, TType.DOUBLE, 'y2', None, None, ),  # 2
    (3, TType.LIST, 'z', (TType.DOUBLE, None, False), None, ),  # 3
)
all_structs.append(SellarDisc1Output)
SellarDisc1Output.thrift_spec = (
    None,  # 0
    (1, TType.DOUBLE, 'y1', None, None, ),  # 1
)
all_structs.append(SellarDisc2Input)
SellarDisc2Input.thrift_spec = (
    None,  # 0
    (1, TType.DOUBLE, 'y1', None, None, ),  # 1
    (2, TType.LIST, 'z', (TType.DOUBLE, None, False), None, ),  # 2
)
all_structs.append(SellarDisc2Output)
SellarDisc2Output.thrift_spec = (
    None,  # 0
